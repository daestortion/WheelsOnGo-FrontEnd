...
export const CarManagementOwner = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(`https://extraordinary-abundance-production.up.railway.app/car/insertCar/${userId}`, formData, {
        headers: {
    ...
    <div className="car-management-owner">
      <div className="overlap-wrapper">
        <div className="overlap">
          ...
          {carImage && (
            <div className="rectangle" style={{ backgroundImage: `url(${URL.createObjectURL(carImage)})` }} />
          )}
